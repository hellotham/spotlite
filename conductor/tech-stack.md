...
- **D3.js:** Interactive data visualisations (e.g. superpowers bar chart, packed circles) integrated with Astro components. Supports responsive resizing, custom tooltips, and theme-aware styling.
...
- **Sharp:** High-performance image processing library used by Astro for optimised assets.
- **ESLint & Prettier:** For maintaining code quality and consistent formatting. Configured with strict accessibility rules (`jsx-a11y`) and optimised UnoCSS linting.
