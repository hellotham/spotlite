...
_One thing in the deck is worth flagging up front. Slide 5 reports Gartner's claim that "service oriented architecture" was coined in 1994 as a synonym for client/server. I had [given a paper on client/server architectures that same year](/spotlite/article/auug-1994/), which I did not know when I put the slide together._
...
- `Banktech06 NAB Chris Tham SOA.ppt`, the presentation file, 29 slides, created 27 June 2006 and last saved 5 July 2006. Reproduced above.
