...
Subjectively, the player exhibited some with audio synchronization on known "problem" discs (_Wedding Singer_ R4 second remastered edition and also _Matrix_ R1). The audio was definitely not synchronized during Steve Buscemi's wedding speech in the former but within acceptable tolerances when Neo is being scolded by his manager for being late at work in the latter.
