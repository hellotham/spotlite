---
title: 'Dynamic Comparison SACD vs CD - Part 5'
description: 'The last of the series: SACD against CD on the same titles, and a look at whether the format or the master is doing the work.'
pubDate: 2004-09-05
categories:
  - 'Published articles'
  - 'Audio and video'
...
[![Figure 1 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart1-1.jpg)](https://www.audioholics.com/audio-technologies/chart1-1.jpg/image) _CD-R captured using the soundcard at 96/24_
...
[![Figure 2 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart1-2.jpg)](https://www.audioholics.com/audio-technologies/chart1-2.jpg/image)
...
[![Figure 3 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart1-3.jpg)](https://www.audioholics.com/audio-technologies/chart1-3.jpg/image) SA_CD layer of Hybrid disc captured using the soundcard at 96/24_
...
[![Figure 4 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart2-1a.gif)](https://www.audioholics.com/audio-technologies/chart2-1a.gif/image) [![Figure 5 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart2-1b.gif)](https://www.audioholics.com/audio-technologies/chart2-1b.gif/image) _omparing an excerpt from track 11 on CD (left) and SACD (right)_
...
![Figure 6 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart2-2.png)
...
![Figure 7 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart3-1.png)
...
![Figure 8 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart3-2.png)
...
![Figure 9 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart3-3.png)
...
_[![Figure 10 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart3-4.png)](https://www.audioholics.com/audio-technologies/chart3-4.jpg/image) Track 1 of the_ _CD layer (recorded using soundcard at 96/24)_
...
[![Figure 12 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart4-2.png)](https://www.audioholics.com/audio-technologies/chart4-2.jpg/image) Frequency analysis around
...
[![Figure 13 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart4-3.png)](https://www.audioholics.com/audio-technologies/chart4-3.jpg/image) Frequency analysis around
...
![Figure 14 from the original article, Dynamic Comparison SACD vs CD - Part 5](../../assets/ah-dynamic-5-chart5-1.jpg)
