...
This is a set of articles summarising my experience choosing the components and building a a custom-built Home Theatre PC running **Microsoft Windows XPMedia CenterEdition 2005** (or " MCE2005" for short). Part 1 is an introduction, Part 2 shows a step by step pictorial guide to assembling the hardware, and the upcoming Parts 3 and 4 detail the software installation and objective and subjective impressions of the results.
