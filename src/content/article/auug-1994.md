...
Architecture Consultant at [AT&T Global Information Solutions](/spotlite/work/ncr/) then. I
revised the paper for Oracle OpenWorld '94, and that version is [also on this
site](/spotlite/article/openworld-1994/). The two agree closely, so this article marks the places
...
_The conference deck survives alongside it, 42 slides with the speaker notes still in them, last
